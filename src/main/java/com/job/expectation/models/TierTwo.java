...
public class TierTwo {
    ...
    private Double EmployeePensionRate = 0.55;
    private Double EmployerPensionRate = 0.00;
...
//        this.setGrossSalary(GrossSalary);
    ...
    public TierTwo(Double grossSalary, Double basicSalary, Double allowance, Double totalPayeTax,
